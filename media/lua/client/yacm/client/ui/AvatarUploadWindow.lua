...
function AvatarUploadWindow:drawHelp()
    ...
    local text = getText('SurvivalGuide_YetAnotherChatMod_AvatarUploadHelp',
...
function AvatarUploadWindow:drawInvalidSize()
    local text = getText('SurvivalGuide_YetAnotherChatMod_AvatarSizeError',
...
function AvatarUploadWindow:sendAvatar()
    ...
    if self._avatarRequest then
        ...
        SendYacmClient.sendAvatarRequest(self._avatarRequest)
