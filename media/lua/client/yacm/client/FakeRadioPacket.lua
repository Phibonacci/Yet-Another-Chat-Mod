...
function FakeRadioPacket.getListeningRadiosPositions(player, range, frequency)
    local radios = {}
    if player == nil then
        print('yacm error: FakeRadioPacket.getListeningRadiosPositions: player is null')
        return nil
    end
    if range == nil then
        print('yacm error: FakeRadioPacket.getListeningRadiosPositions: range is null')
        return nil
    end
    if frequency == nil then
        print('yacm error: FakeRadioPacket.getListeningRadiosPositions: frequency is null')
        return nil
    end
